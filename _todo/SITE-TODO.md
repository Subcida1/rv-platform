...
Remaining: slice 4, component brand pages (~101 brands, and see the thin-content note
below before building them); slice 6, the full-corpus search head set; slice 7, a
...
bundle. Today only the nine section pages are indexed, in a `Manual` category capped at
two results like businesses.
