...
| C13 | **SAFETY: do not prop a ladder against the body** of the coach, because it damages the finish | Jayco's owner manual, quoted | READ, and the page now states the second consequence as well: a ladder that slips from there is a fall (roof review JOB-20260924-2102, 2026-09-24) |
| C14 | the roof has decking under the membrane and can be walked on with caution | Jayco's owner manual, quoted | **CORRECTED 2026-09-24.** True of this maker's roof; false as a general rule, and dangerous stated as one. The review (JOB-20260924-2102) found the page generalising it to every RV roof, when aluminium, thin fibreglass and some rubber-over-luan roofs are not built to carry a person. The page now says walkability depends on the unit and that the owner's manual is what settles it. The quote above is retained as what the maker's manual says, not as what every roof can take. |
